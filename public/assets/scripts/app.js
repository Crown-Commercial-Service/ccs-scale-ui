"use strict";/* global $ */document.addEventListener("DOMContentLoaded",function(event){if(typeof jQuery!="undefined"){$("body").addClass("js-enabled");// Initialise all the GOV.UK Frontend components
window.GOVUKFrontend.initAll()}// Check for if an element exists
